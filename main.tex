...
Let the required point = C\myvec{0\\y}

Given the point on y-axis is equidistance from A and B

Distance between two points given as
\begin{align}
...
\boxed{\sqrt{(x_3-x_1)^2+(y_3-y_1)^2}= \sqrt{(x_3-x_2)^2+(y_3-y_2)^2}}\\

\sqrt{(0-6)^2+(y-5)^2}=\sqrt{(0-(-4))^2+(y-3)^2}

Squaring on both sides
\begin{align}
\implies(y-5)^2+36=(y-3)^2+16\\
\implies y^2+25-10y+36=y^2+9-6y+16\\
\implies61-10y=25-6y
\implies4y=36\\
\implies\boxed{y=9}
\end{align}
Finally the point 'C' on y-axis eqidistance from A and B is \myvec{0\\9}
