...
\begin{align}
\boxed{\norm{\vec{x}}^2-2 \vec{A}^T \vec{x}+\vec{A}^T \vec{A}=\norm{\vec{x}}^2-2 \vec{B}^T \vec{x}+\vec{B}^T \vec{B}}\\
...
\begin{align}
2\vec{ye_2}(\vec{A}^T-\vec{B}^T)=\norm{\vec{A}}^2-\norm{\vec{B}}^2\\
\boxed{\vec{y}=\dfrac{\vec{//A//}^2-\vec{//B//}^2}{\vec{2e_2}.(\vec{A}^T-\vec{B}^T)}}\\
\vec{2e_2}.(\vec{A}^T-\vec{B}^T)=2\myvec{0\\1}.\myvec{10\ 2}=4\\
